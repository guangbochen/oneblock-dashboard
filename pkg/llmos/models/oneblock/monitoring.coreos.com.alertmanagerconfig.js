...
export default class HciAlertmanagerConfig extends SteveModel {
  get _detailLocation() {
    return {
      ...
      params: {
        ...
        resource:  LLMOS.ALERTMANAGERCONFIG,
  ...
  get doneOverride() {
    ...
    detailLocation.params.resource = LLMOS.ALERTMANAGERCONFIG;
  ...
  get parentNameOverride() {
    return this.$rootGetters['i18n/t'](`typeLabel."${ LLMOS.ALERTMANAGERCONFIG }"`, { count: 1 })?.trim();
  }
