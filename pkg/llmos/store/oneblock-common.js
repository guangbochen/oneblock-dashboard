...
import { LLMOS } from '@pkg/types/types';
import { PRODUCT_NAME } from '~/pkg/llmos/config/product';
  ...
  async bundleProgress({
    ...
    const timer = setInterval(async() => {
      ...
      if (bundleCrd.bundleState !== 'ready') {
        bundleCrd = rootGetters['llmos/byId'](LLMOS.SUPPORT_BUNDLE, id);
