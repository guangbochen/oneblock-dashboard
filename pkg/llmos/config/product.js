...
export const PRODUCT_NAME = 'llmos';
...
export function init($plugin, store) {
  ...
  store.dispatch('setIsSingleProduct', {
    ...
    productNameKey:    'llmos.productLabel',
    getVersionInfo:    (store) => store.getters[`${ PRODUCT_NAME }/byId`]?.(LLMOS.SETTING, 'server-version')?.value || 'unknown',
  ...
  // notebook page
  // basicType([LLMOS.NOTEBOOK]);
  // configureType(LLMOS.NOTEBOOK, {
  //   location: {
  //     name:   `${ PRODUCT_NAME }-c-cluster-resource`,
  //     params: { resource: LLMOS.NOTEBOOK }
  //   },
  //   resource:       LLMOS.NOTEBOOK,
  //   resourceDetail: LLMOS.NOTEBOOK,
  //   resourceEdit:   LLMOS.NOTEBOOK
  // });
  //
  // virtualType({
  //   label:      'Notebooks',
  ...
  // configureType(LLMOS.QUEUE, {
  //   location: {
  //     name:   `${ PRODUCT_NAME }-c-cluster-resource`,
  //     params: { resource: LLMOS.QUEUE }
  //   },
  //   resource:       LLMOS.QUEUE,
  //   resourceDetail: LLMOS.QUEUE,
  //   resourceEdit:   LLMOS.QUEUE,
  //   isCreatable:    true,
  // });
  // virtualType({
  //   label:      'Scheduling Queues',
  //   group:      'root',
  //   ifHaveType: LLMOS.QUEUE,
  //   name:       LLMOS.QUEUE,
  //   namespaced: false,
  //   weight:     79,
  //   route:      {
  ...
  //   group:      'advanced',
  //   name:       LLMOS.ADD_ONS,
  //   ifHaveType: LLMOS.ADD_ONS,
  //   weight:     -900,
  //   namespaced: false,
  //   route:      {
  //     name:   `${ PRODUCT_NAME }-c-cluster-resource`,
  //     params: { resource: LLMOS.ADD_ONS }
  //   },
  //   exact: false,
  // });

  // addvanced => settings
  configureType(LLMOS.SETTING, { isCreatable: false });
  virtualType({
    ifHaveType: LLMOS.SETTING,
    ifHaveVerb: 'POST',
    label:      'Settings',
    name:       LLMOS.SETTING,
    weight:     -1000,
